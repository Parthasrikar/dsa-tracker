        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="glass-card p-6 rounded-2xl space-y-4 sticky top-24">
              ...
              <textarea
                className="w-full bg-black/20 rounded-lg p-3 text-sm focus:ring-1 ring-primary outline-none min-h-[150px] resize-none border border-white/20 focus:border-primary transition-all"
                            ...
                            <div key={p._id} className="group flex items-center justify-between bg-black/20 hover:bg-black/30 p-3 rounded-lg text-sm border border-transparent hover:border-white/5 transition-all">
                              ...
                              <div className="flex items-center gap-3 shrink-0">
                                ...
                                <button
                                  ...
                                  className="opacity-100 lg:opacity-0 lg:group-hover:opacity-100 text-muted-foreground hover:text-red-500 transition-all p-1"
                                >
                                  <Trash2 size={14} />
                                </button>
                              </div>
...
function DayInput({ label, initialValue, onSave, placeholder, minHeight = "min-h-[80px]" }: DayInputProps) {
  ...
  return (
    <div className="space-y-1">
      ...
      <textarea
        className={`w-full bg-black/20 rounded-lg p-3 text-sm focus:ring-1 ring-primary outline-none resize-none border border-white/20 ${minHeight}`}
